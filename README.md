...
* Для отправки данных из локального репозитория на удаленный, после сохранения и коммита,  необходимо написать следующую команду:

> git push

* Для загрузки данных из удаленног орепозитория в локальный, необходимо прописать следующую команду:
